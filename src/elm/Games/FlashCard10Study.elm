module Games.FlashCard10Study exposing (..)
...
-- FlashCard10Study View
flashcard10study : Model -> Html Msg
flashcard10study model =
  div [ class "container" ] [
    text "Current Mode: Study",

module Games.FlashCard10Exam exposing (..)
...
-- FlashCard10Exam View
flashcard10exam : Model -> Html Msg
flashcard10exam model =
  div [ class "container" ] [
    text "Current Mode: Exam",

...
var author$project$Main$stepLanding = F2(
	function (mainModel, _n0) {
		var pageModel = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				mainModel,
				{
					page: author$project$Main$Landing(pageModel)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$LandingMsg, cmds));
	});
	...
	function (mainModel, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				mainModel,
				{
					page: author$project$Main$SignUp(pageModel)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$SignUpMsg, cmds));
	});
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Pages$Landing$init = _Utils_Tuple2(
	{},
	elm$core$Platform$Cmd$none);
var author$project$Pages$Login$init = _Utils_Tuple2(
	{email: '', error: elm$core$Maybe$Nothing, secret: ''},
	elm$core$Platform$Cmd$none);
var author$project$Pages$SignUp$init = _Utils_Tuple2(
	{email: '', error: elm$core$Maybe$Nothing, secret: '', verify: ''},
	elm$core$Platform$Cmd$none);
		...
		var parser = elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					...
					A2(author$project$Main$stepLanding, model, author$project$Pages$Landing$init)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('signup'),
					A2(author$project$Main$stepSignUp, model, author$project$Pages$SignUp$init)),
					A2(
					author$project$Main$route,
					elm$url$Url$Parser$s('login'),
					A2(author$project$Main$stepLogin, model, author$project$Pages$Login$init))
				]));
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		return A2(
			...
			url,
			{key: key, page: author$project$Main$NotFound, session: elm$core$Maybe$Nothing});
	});
var author$project$Main$SessionChanged = function (a) {
	return {$: 'SessionChanged', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Main$updateSession = _Platform_incomingPort('updateSession', elm$json$Json$Decode$value);
var author$project$Main$subscriptions = function (model) {
	return author$project$Main$updateSession(author$project$Main$SessionChanged);
};
var author$project$Pages$Landing$update = F2(
	function (msg, model) {
...
var author$project$Session$Session = F3(
	function (accountId, userId, token) {
		return {accountId: accountId, token: token, userId: userId};
	});
...
var author$project$Session$decoder = A4(
...
var author$project$Pages$Login$login = function (model) {
				...
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'pass',
							elm$json$Json$Encode$string(model.secret))
						]))),
			expect: A2(elm$http$Http$expectJson, author$project$Pages$Login$GotLogin, author$project$Session$decoder),
	...
	var json = elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'accountId',
				elm$json$Json$Encode$string(session.accountId)),
				_Utils_Tuple2(
				'userId',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, elm$json$Json$Encode$string, session.userId)),
				_Utils_Tuple2(
				'token',
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Login':
				return _Utils_Tuple2(
					model,
					author$project$Pages$Login$login(model));
			case 'GotLogin':
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					var errorText = function () {
						if (error.$ === 'BadStatus') {
							var status = error.a;
							return (status === 401) ? 'Email or Password incorrect.' : 'Unable to Log in at this time.';
						} else {
							return 'Unable to Log in at this time.';
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: elm$core$Maybe$Just(errorText)
							}),
						elm$core$Platform$Cmd$none);
				}
			default:
...
var author$project$Main$update = F2(
	function (message, model) {
		switch (message.$) {
			case 'SessionChanged':
				var value = message.a;
				var _n1 = A2(elm$json$Json$Decode$decodeValue, author$project$Session$decoder, value);
				if (_n1.$ === 'Ok') {
					var session = _n1.a;
					var asdf = A2(elm$core$Debug$log, 'test', session);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'LandingMsg':
				...
				if (_n3.$ === 'Landing') {
					var pageModel = _n3.a;
					return A2(
						author$project$Main$stepLanding,
						model,
						A2(author$project$Pages$Landing$update, msg, pageModel));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'SignUpMsg':
				...
				if (_n4.$ === 'SignUp') {
					...
					return A2(
						...
						model,
						A2(author$project$Pages$SignUp$update, msg, pageModel));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'LoginMsg':
				...
				if (_n5.$ === 'Login') {
					...
					return A2(
						...
						model,
						A2(author$project$Pages$Login$update, msg, pageModel));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
...
var author$project$Pages$Landing$view = function (model) {
	return {
		attrs: _List_Nil,
		kids: _List_fromArray(
			[
				elm$html$Html$text('This is the Landing Page')
			]),
		title: 'Landing'
	};
};
var author$project$Pages$Login$Email = function (a) {
	return {$: 'Email', a: a};
};
var author$project$Pages$Login$Login = {$: 'Login'};
var author$project$Pages$Login$Secret = function (a) {
	return {$: 'Secret', a: a};
};
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Events$onInput(author$project$Pages$Login$Email)
								]),
							_List_Nil),
							A2(
							elm$html$Html$input,
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$value(model.secret),
									elm$html$Html$Events$onInput(author$project$Pages$Login$Secret)
								]),
							_List_Nil),
							A2(
							elm$html$Html$button,
...
var author$project$Pages$Problem$notFound = _List_fromArray(
	[
		A2(
		elm$html$Html$div,
		_List_fromArray(
...
var author$project$Pages$Problem$styles = _List_fromArray(
	[
		A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
...
var author$project$Pages$SignUp$Secret = function (a) {
	return {$: 'Secret', a: a};
};
var author$project$Pages$SignUp$Verify = function (a) {
	return {$: 'Verify', a: a};
};
						...
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$type_('Password'),
									elm$html$Html$Attributes$value(model.secret),
									elm$html$Html$Events$onInput(author$project$Pages$SignUp$Secret)
								]),
							_List_Nil),
							A2(
							elm$html$Html$input,
							_List_fromArray(
								[
									elm$html$Html$Attributes$type_('Verify Password'),
									elm$html$Html$Attributes$value(model.verify),
									elm$html$Html$Events$onInput(author$project$Pages$SignUp$Verify)
								]),
							_List_Nil)
						]),
					function () {
...
var author$project$Skeleton$viewFooter = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$text('this is the footer')
		]));
var author$project$Skeleton$viewHeader = function (maybeSession) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Skeleton$view = F3(
	function (maybeSession, toMsg, details) {
		return {
			body: _List_fromArray(
				[
					author$project$Skeleton$viewHeader(maybeSession),
					A2(
					elm$html$Html$map,
					toMsg,
					A2(
...
var author$project$Main$view = function (model) {
	var viewPage = author$project$Skeleton$view(model.session);
	var _n0 = model.page;
	switch (_n0.$) {
		case 'NotFound':
			return A2(
				...
				{attrs: author$project$Pages$Problem$styles, kids: author$project$Pages$Problem$notFound, title: 'Not Found'});
		case 'Landing':
			var pageModel = _n0.a;
			return A2(
				viewPage,
				author$project$Main$LandingMsg,
				author$project$Pages$Landing$view(pageModel));
		case 'Login':
			var pageModel = _n0.a;
			return A2(
				viewPage,
				author$project$Main$LoginMsg,
				author$project$Pages$Login$view(pageModel));
		case 'SignUp':
			var pageModel = _n0.a;
			return A2(
				viewPage,
				author$project$Main$SignUpMsg,
				author$project$Pages$SignUp$view(pageModel));
		default:
			return A2(
				viewPage,
				elm$core$Basics$never,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Session.Session":{"args":[],"type":"{ accountId : String.String, userId : Maybe.Maybe String.String, token : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LandingMsg":["Pages.Landing.Msg"],"LinkClicked":["Browser.UrlRequest"],"LoginMsg":["Pages.Login.Msg"],"SignUpMsg":["Pages.SignUp.Msg"],"SettingsMsg":["Pages.Settings.Msg"],"UrlChanged":["Url.Url"],"SessionChanged":["Json.Decode.Value"]}},"Pages.Landing.Msg":{"args":[],"tags":{"NoOp":[]}},"Pages.Login.Msg":{"args":[],"tags":{"Email":["String.String"],"Secret":["String.String"],"Error":["String.String"],"Login":[],"GotLogin":["Result.Result Http.Error Session.Session"],"SaveSuccess":[]}},"Pages.Settings.Msg":{"args":[],"tags":{"GotAccountInfo":["Session.Session"]}},"Pages.SignUp.Msg":{"args":[],"tags":{"Email":["String.String"],"Secret":["String.String"],"Verify":["String.String"],"Error":["String.String"],"SignedUp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});
...
var flags = {
  ...
  "session": localStorage.getItem(_constants.default.storageKeys.session)
};
...
app.ports.storeSession.subscribe(function (val) {
  if (val === null) {
    ...
    localStorage.setItem(_constants.default.storageKeys.session, JSON.stringify(val));
  } // Report that the new session was stored succesfully.


  setTimeout(function () {
    app.ports.updateSession.send(val);
  }, 0);
}); // Whenever localStorage changes in another tab, report it if necessary.

window.addEventListener("storage", function (event) {
  if (event.storageArea === localStorage) {
    if (event.key === _constants.default.storageKeys.session) {
      app.ports.updateSession.send(event.newValue);
    }
  }
}, false);
},{"./src/Main.elm":"src/Main.elm","./constants.js":"constants.js"}],"../../n/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33877" + '/');
...
//# sourceMappingURL=/flashcard-elm.e31bb0bc.js.map